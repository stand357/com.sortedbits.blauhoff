...
const setWorkmodeAndZeroExportPower = async (origin: IBaseLogger, args: any, client: IAPI): Promise<void> => {
    ...
    const modeRegister = DeviceRepository.getRegisterByTypeAndAddress(client.getDeviceModel(), registerType, modeAddress);
...
const setTimeOfUseTimeslotParameters = async (origin: IBaseLogger, args: any, client: IAPI): Promise<void> => {
    ...
    const chargeRegister = DeviceRepository.getRegisterByTypeAndAddress(client.getDeviceModel(), RegisterType.Holding, chargeAddress);
    const powerRegister = DeviceRepository.getRegisterByTypeAndAddress(client.getDeviceModel(), RegisterType.Holding, powerAddress);
    const batteryRegister = DeviceRepository.getRegisterByTypeAndAddress(client.getDeviceModel(), RegisterType.Holding, batteryAddress);
    const timeRegister = DeviceRepository.getRegisterByTypeAndAddress(client.getDeviceModel(), RegisterType.Holding, timeAddress);
